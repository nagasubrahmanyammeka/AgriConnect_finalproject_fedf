...
<br/>
        ...
        <p>Click Here to See the Suggestions Provided by the Experts  - <button
        style={{ marginTop: 20, padding: "10px 16px", cursor: "pointer" }}
        onClick={() => navigate("/all-guidance")}
      >
        See Suggestions
      </button></p>
      <p>Click Here to See the Contents Assisted by the Experts  - <button
        style={{ marginTop: 20, padding: "10px 16px", cursor: "pointer" }}
        onClick={() => navigate("/all-content")}
      >
        View Contents
      </button></p>
        <p>To Submit Feedback About your Experience  - <button
        style={{ marginTop: 20, padding: "10px 16px", cursor: "pointer" }}
